...
void printTreeLines(BinaryTreeNode* pRoot)
{
    if (nullptr == pRoot)
        return;
    ...
    // 记录下一行要打印的节点数，起始一行为头结点
    int nNumsNodeInNextLevel = 0;
    ...
    while(dequeTreeNode.size())
    {
        ...
        {
            printf("\n");
            nToBePrinted = nNumsNodeInNextLevel;
            nNumsNodeInNextLevel = 0;
        }
    }
}
